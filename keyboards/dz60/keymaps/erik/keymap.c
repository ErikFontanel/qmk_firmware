...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_60_b_iso(
		...
		HYPR(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_BSLS, KC_ENT,
		KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSPC, KC_UP, LT(1, KC_DEL),
		KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_N, KC_M, KC_LEFT, KC_DOWN, KC_RGHT),
	...
	LAYOUT_60_b_iso(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_M_R, RGB_TOG, BL_DEC, BL_STEP),
